...
import { articles } from './foo.model';
...
export class FooComponent {
  ...
  makeRequest(): void {
    ...
    this.o = this.http.get('https://my-json-server.typicode.com/CarpioNick4/redditangular/articles/');
  ...
  getData = (d : Object) =>
  {
   ...
   makeTypedRequest() : void
   {
     ...
     this.oFoo = this.http.get<articles[]>('https://my-json-server.typicode.com/CarpioNick4/redditangular/articles/');
